...
contract FarmOrDie is Ownable {
    ...
    string public constant name = "FarmOrDie";
    ...
    function burn(uint256 epoch) external onlyOwner returns (uint256)
    {
        _totalSupply = _totalSupply.mul(95);
